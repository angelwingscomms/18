/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b7adcc18265f94a78171c40915e5d7dd)
// Runtime types generated with workerd@1.20260701.1 2026-07-05 nodejs_als
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	QDRANT_URL: "https://a154ee19-467b-41d1-9fb8-91139b49b0a0.eu-west-2-0.aws.cloud.qdrant.io";
	GEMINI: string;
	EXA_API_KEY: string;
	GOOGLE_ID: string;
